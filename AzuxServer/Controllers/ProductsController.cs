...
namespace AzuxServer.Controllers
{
    ...
    */
    public class ProductsController : ODataController
    {
        ...
        {
            return SingleResult.Create(db.Product.Where(m => m.Id == key).Select(m => m.Category));
        }

        // GET: odata/Products(5)/ProductEntry
        [EnableQuery]
        public IQueryable<ProductEntry> GetProductEntry([FromODataUri] int key)
        {
            return db.Product.Where(m => m.Id == key).SelectMany(m => m.ProductEntry);
        }
